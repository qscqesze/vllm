...
# adapted from https://huggingface.co/MiniMaxai/MiniMaxvl-mississippi-2b/blob/main/modeling_MiniMaxvl_chat.py
# https://huggingface.co/MiniMaxai/MiniMaxvl-mississippi-2b/blob/main/image_process.py
# --------------------------------------------------------
# MiniMaxVL-Mississippi
# Copyright (c) 2024 MiniMax.AI
...
def resolve_MiniMaxvl_min_max_num(
    *,
...
def get_MiniMaxvl_target_ratios(
    min_num: int,
    max_num: int,
    *,
...
def calculate_MiniMaxvl_targets(
    *,
    orig_width: int,
    orig_height: int,
...
def dynamic_preprocess_MiniMaxvl(
    image: Image.Image,
    *,
    target_ratios: list[tuple[int, int]],
    image_size: int,
...
def _preprocess_image(
    ...
    *,
    ...
    target_ratios = get_MiniMaxvl_target_ratios(
        min_num,
        max_num,
    ...
    images, target_aspect_ratio = dynamic_preprocess_MiniMaxvl(
        image,
...
def image_to_pixel_values_MiniMaxvl(
    image: Image.Image,
    *,
    input_size: int,
    min_num: int,
...
class MiniMaxVLProcessor(BaseInternVLProcessor):
    ...
    def resolve_min_max_num(
        ...
        *,
        ...
        return resolve_MiniMaxvl_min_max_num(
            min_dynamic_patch=min_dynamic_patch,
            max_dynamic_patch=max_dynamic_patch,
            dynamic_image_size=dynamic_image_size,
            use_thumbnail=use_thumbnail,
    ...
    def resolve_target_ratios(
        ...
        *,
        ...
        return get_MiniMaxvl_target_ratios(
            min_num,
            max_num,
            prior_aspect_ratio=prior_aspect_ratio,
        )
    ...
    def get_num_image_tokens(
        ...
        *,
        ...
        if use_msac:
            ...
            num_patches_1, _, _, aspect_ratio_1 = calculate_MiniMaxvl_targets(
            ...
            num_patches_2, _, _, _ = calculate_MiniMaxvl_targets(
                orig_width=image_width,
                orig_height=image_height,
                image_size=self.image_size,
            ...
            num_patches, _, _, _ = calculate_MiniMaxvl_targets(
                orig_width=image_width,
                orig_height=image_height,
                image_size=self.image_size,
                target_ratios=target_ratios,
    ...
    def _images_to_pixel_values_lst(
        ...
        return [
            image_to_pixel_values_MiniMaxvl(
                image,
...
class MiniMaxVLProcessingInfo(BaseInternVLProcessingInfo):
    ...
    def get_num_image_tokens(
        ...
        *,
        image_width: int,
        image_height: int,
        processor: Optional[MiniMaxVLProcessor],
        use_msac: Optional[bool] = None,
    ) -> int:
...
class MiniMaxVLMultiModalProcessor(InternVLMultiModalProcessor[MiniMaxVLProcessingInfo]
                               ):
...
@MULTIMODAL_REGISTRY.register_processor(
    MiniMaxVLMultiModalProcessor,
    info=MiniMaxVLProcessingInfo,
    dummy_inputs=InternVLDummyInputsBuilder)
class AbabForCausalLM(InternVLChatModel):
    ...
    def _init_vision_model(
        ...
        *,
        ...
        if not is_mono:
            ...
            msg = "Monolith mode is not applicable to MiniMaxVL"
